...
int main(void) {
    ...
    Obj* sphere_left = create_sphere(new_vec3(-1.0, 0, -1.0), 0.5, create_metal(new_color(0.8, 0.8, 0.8)));
    Obj* sphere_right = create_sphere(new_vec3(1.0, 0, -1.0), 0.5, create_metal(new_color(0.8, 0.6, 0.2)));
    ...
    Camera *cam = new_camera(16.0/9.0, 400, 100, 100);
    render(cam, world);
