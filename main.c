...
int main(void) {
    ...
    //Obj* sphere_left_bubble = create_sphere(new_vec3(-1.0, 0, -1.0), 0.4, create_dielectric((1.00/1.50)));
    //Obj* sphere_left = create_sphere(new_vec3(-1.0, 0, -1.0), 0.5, create_metal(new_color(0.8, 0.8, 0.8), 0.3));
    ...
    //hittables_add(world, sphere_left_bubble);
